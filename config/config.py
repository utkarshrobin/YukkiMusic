...
API_ID = int(getenv("API_ID", "25272906"))

API_HASH = getenv("API_HASH", "a341f3a7733db7bf7202708926baab42")


## Get it from @Botfather in Telegram.
BOT_TOKEN = getenv("BOT_TOKEN", "7299503684:AAFLbJQHevUW8d1OSFoC-Wx7stpmW74lVCE")


# Database to save your chats and stats... Get MongoDB:-  https://telegra.ph/How-To-get-Mongodb-URI-04-06
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://techbrou:pandey2120@cluster0.oog5hnb.mongodb.net/?retryWrites=true&w=majority")
...
LOG_GROUP_ID = getenv("LOG_GROUP_ID", "-4610303222")


# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "7630368390").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/utkarshrobin/YukkiMusic",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/helloocrazyyy200"
)  # Example:- https://t.me/TheTeamVivek
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/helium_says"
